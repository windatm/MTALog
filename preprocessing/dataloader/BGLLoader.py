...
class BGLLoader(BasicDataLoader):
    def __init__(
        ...
        log_file_path = os.path.join(LOG_ROOT, "BGLLoader.log")
...
if __name__ == "__main__":
    ...
    loader = BGLLoader(
        in_file=os.path.join(PROJECT_ROOT, "datasets/temp_BGL/BGL.log"),
        dataset_base=os.path.join(PROJECT_ROOT, "datasets/temp_BGL"),
        semantic_repr_func=semantic_encoder.present,
    )
    loader.parse_by_IBM(
        config_file=os.path.join(PROJECT_ROOT, "conf/BGL.ini"),
